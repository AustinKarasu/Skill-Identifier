export const API_ENDPOINTS = {
  ...
  manager: {
    ...
    updateCandidateSettings: (id, section) => `/manager/candidates/${id}/settings/${section}`,
    enableCandidateTwoFactor: (id) => `/manager/candidates/${id}/2fa/enable`,
    disableCandidateTwoFactor: (id) => `/manager/candidates/${id}/2fa/disable`,
