...
export const managerOpsService = {
  ...
  async updateCandidateSettings(employeeId, section, payload) {
    const response = await apiClient.put(API_ENDPOINTS.manager.updateCandidateSettings(employeeId, section), payload)
    return response.data
  },

  async enableCandidateTwoFactor(employeeId) {
    const response = await apiClient.post(API_ENDPOINTS.manager.enableCandidateTwoFactor(employeeId))
    return response.data
  },

  async disableCandidateTwoFactor(employeeId) {
    const response = await apiClient.post(API_ENDPOINTS.manager.disableCandidateTwoFactor(employeeId))
    return response.data
  },
