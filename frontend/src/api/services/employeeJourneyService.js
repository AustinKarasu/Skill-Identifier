...
export const employeeJourneyService = {
  ...
  async reportInterviewProctoring({ sessionId, eventType, personCount, warningCount, action, metrics }) {
  ...
  async saveInterviewResult({ answers, durationMinutes, sessionId, behaviorMetrics }) {
